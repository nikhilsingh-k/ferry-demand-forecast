...
FINAL STABLE PRODUCTION VERSION - Critical bugs fixed
"""
...
# Use larger evaluation window for KPI stability
# FIX: use full test set for KPIs — small 96-row windows give unstable stats
X_eval = X_test_full
y_eval = y_test_full
...
# ==================== FIX 3: Proper Model-Specific Residuals ====================
try:
...
# 🔥 IMPORTANT: use FULL prediction here
# FIX: eval_pred_full must cover the full test set (y_eval)
...
# ==================== FIX 1 & 4: Safe KPI Display ====================
def safe_format(val, fmt="{:.1f}", suffix=""):
    if val is None or pd.isna(val) or np.isinf(val):
        return "N/A"
    return fmt.format(val) + suffix

# Enhanced KPI Cards - Replace your old KPI section with this
